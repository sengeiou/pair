...
public class SensitiveExample
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		/**
		 *
		 * API 文档: http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#getList 查询敏感词列表方法
		 *
		 */
		...
		/**
		 *
		 * API 文档: http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#remove 移除敏感词方法（从敏感词列表中，移除某一敏感词。）
		 *
		 */
		...
		/**
		 *
		 * API 文档: http://www.rongcloud.cn/docs/server_sdk_api/sensitive/sensitive.html#remove 批量移除敏感词方法（从敏感词列表中，批量移除某一敏感词。）
		 *
		 */
		String[] words = { "黄赌毒" };
