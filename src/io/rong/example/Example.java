...
public class Example
{
	...
	{
		String appKey = "vnroth0kvbzco";
		String appSecret = "yXiswjMG6QnKel";
	...
	{
		UserModel user = new UserModel().setId("1").setName("wzt").setPortrait("http://b-ssl.duitang.com/uploads/item/201812/07/20181207173003_zdddw.jpg");
		// UserModel user = new UserModel().setId("2").setName("yq").setPortrait("http://b-ssl.duitang.com/uploads/item/201812/07/20181207173003_zdddw.jpg");
	...
	{
		UserModel user = new UserModel().setId("userId1").setName("username").setPortrait("http://www.rongcloud.cn/images/logo.png");
	...
	{
		BroadcastMessage message = new BroadcastMessage().setSenderId("OScHVP1tQ").setObjectName(txtMessage.getType()).setContent(txtMessage).setPushContent("this is a push").setPushData("{'pushData':'hello'}").setOs("Android");
	...
	{
		Reader reader = null;
		PrivateMessage privateMessage = new PrivateMessage().setSenderId("userId").setTargetId(targetIds).setObjectName(voiceMessage.getType()).setContent(voiceMessage).setPushContent("").setPushData("{\"pushData\":\"hello\"}").setCount("4").setVerifyBlacklist(0).setIsPersisted(0).setIsCounted(0).setIsIncludeSender(0);
	...
	{
		RecallMessage message = new RecallMessage().setSenderId("OScHVP1tQ").setTargetId("NomSvNyME").setuId("B8FV-QAHO-I1E4-JLRI").setSentTime("1548334967010");
	...
	{
		// 群组消息
		GroupMessage groupMessage = new GroupMessage().setSenderId("Hji8yh76").setTargetId(targetIds).setObjectName(txtMessage.getType()).setContent(txtMessage).setPushContent("this is a push").setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0).setIsIncludeSender(0).setContentAvailable(0);
	...
	public void testSendGroupMention() throws Exception
	{
		...
		MentionMessage mentionMessage = new MentionMessage().setSenderId("userId").setTargetId(targetId).setObjectName(txtMessage.getType()).setContent(content).setPushContent("this is a push").setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0).setIsCounted(0).setIsIncludeSender(0).setContentAvailable(0);
	...
	public void testSendGroupDirection() throws Exception
	{
		...
		GroupMessage groupMessage = new GroupMessage().setSenderId("XN3gZdUOB").setTargetId(targetIds).setToUserId(toUserIds).setObjectName(txtMessage.getType()).setContent(txtMessage).setPushContent("this is a push").setPushData("{\"pushData\":\"hello\"}").setIsPersisted(0).setIsIncludeSender(0).setContentAvailable(0);
	...
	{
		RecallMessage message = new RecallMessage().setSenderId("NomSvNyME").setTargetId("BauMbEShY").setuId("B8FV-UKT9-TJMD-KV6A").setSentTime("1548335533735");
	...
	{
		// 聊天室消息
		ChatroomMessage message = new ChatroomMessage().setSenderId("targetIds").setTargetId(targetIds).setContent(txtMessage).setObjectName(txtMessage.getType());
	...
	public void testGroupCreate() throws Exception
	{
		...
		GroupModel group = new GroupModel().setId("ghJiu7H3").setMembers(members).setName("groupName");
	...
	{
		ChatroomModel[] chatrooms = { new ChatroomModel().setId("chatroomId1").setName("chatroomName1"), new ChatroomModel().setId("chatroomId2").setName("chatroomName2") };
	...
	public void testGetChatroom() throws Exception
	{
		...
		ResponseResult result = rongCloud.chatroom.create(chatrooms);
		ChatroomModel chatroomModel = new ChatroomModel().setId("chatroomId1").setCount(500).setOrder(1);
	...
	{
		ChatroomMember[] members = { new ChatroomMember().setId("qawr34h"), new ChatroomMember().setId("qawr35h") };
		ChatroomModel chatroom = new ChatroomModel().setId("d7ec7a8b8d8546c98b0973417209a548").setMembers(members).setMinute(5);
